...
import { addDevision } from '../../services/devisionServices';
import { Notification } from "../Layout/Notification";

export const AddDevision = ({ onClose, refreshData }) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await addDevision(formData);
    ...
    <div dir="rtl" className="fixed inset-0 bg-black/30 backdrop-blur-sm bg-opacity-50 flex items-center justify-center">
      <div className="bg-white rounded-lg p-6 w-full max-w-md">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-bold">إضافة مصلحة جديدة</h2>
